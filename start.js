...
function copyJs() {
  return src('./node_modules/accessible-autocomplete/dist/accessible-autocomplete.min.js')
    .pipe(dest('./public/javascripts'))
}

function copyCss() {
  return src('./node_modules/accessible-autocomplete/dist/accessible-autocomplete.min.css')
